...
<body>
                    ...
                    <div class="box" style="width: 255px; height:355px;">
                        ...
                        <form action="" method="POST">
                            ...
                            <button onclick="myFunction()" name="add_to_cart"><img src="./images/cart2.png" alt="Add to cart">
                                <a href="book_details.php?details=<?php echo $fetch_book['bid'];
                                                                    echo '-name=', $fetch_book['name']; ?>" class="update_btn">View Details</a>
                        </form>
    ...
    <section class="show-products">
        <div class="box-container">
            ...
            <?php
            $select_book = mysqli_query($conn, "SELECT * FROM `book_info` where category='Horor'") or die('query failed');
            if (mysqli_num_rows($select_book) > 0) {
                while ($fetch_book = mysqli_fetch_assoc($select_book)) {
            ?>
    ...
    <section class="show-products">
        <div class="box-container">
            ...
            <?php
            $select_book = mysqli_query($conn, "SELECT * FROM `book_info` where category='Academic'") or die('query failed');
            if (mysqli_num_rows($select_book) > 0) {
                while ($fetch_book = mysqli_fetch_assoc($select_book)) {
            ?>

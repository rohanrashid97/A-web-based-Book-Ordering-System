  ...
  <header>
    ...
    <div class="nav">
        ...
        <div class="dropdown">
            ...
            <a href="http://localhost/Bookorderingsystem/index.php#New">New Arrived</a>
                <a href="http://localhost/bookorderingsystem/index.php#Adventure">Adventure</a>
                <a href="http://localhost/Bookorderingsystem/index.php#Magical">Magic</a>
                <a href="http://localhost/Bookorderingsystem/index.php#Knowledge">Knowledge</a>
                <a href="http://localhost/Bookorderingsystem/index.php#Academic">Academic</a>
            </div>
        </div>
